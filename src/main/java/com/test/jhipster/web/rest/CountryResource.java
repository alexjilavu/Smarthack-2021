...
import com.test.jhipster.domain.Country;
import com.test.jhipster.repository.CountryRepository;
import com.test.jhipster.service.CountryQueryService;
import com.test.jhipster.service.CountryService;
import com.test.jhipster.service.criteria.CountryCriteria;
...
/**
 * REST controller for managing {@link com.test.jhipster.domain.Country}.
 */
@RestController
@RequestMapping("/api")
public class CountryResource {
    ...
    public ResponseEntity<List<Country>> getAllCountries(CountryCriteria criteria, Pageable pageable) {
